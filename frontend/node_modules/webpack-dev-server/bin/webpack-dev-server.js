...
yargs.options({
	...
	"history-api-fallback": {
		type: "boolean",
		describe: "Fallback to /3333.html for Single Page Applications.",
		group: RESPONSE_GROUP
	},
	"compress": {
		type: "boolean",
...
function reportReadiness(uri, options) {
	...
	if(options.historyApiFallback)
		console.log("404s will fallback to " + colorInfo(useColor, options.historyApiFallback.index || "/3333.html"));
	if(options.open)
		open(uri);
}
